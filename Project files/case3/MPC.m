...
a0 = 100; % abscissa of Obstacle0
b0 = 10;  % ordinate of Obstacle0
h0 = 45;  % height of Obstacle0
a1 = 280; % abscissa of Obstacle1
b1 = 1;  % ordinate of Obstacle2 
h1 = 45;  % height of obstacle1
a2 = 490; % abscissa of Obstacle2
b2 = 1;  % ordinate of Obstacle2
h2 = 45;  % height of obstacle2
...
sys = ICtSystem(...
    ...
    -floor((7-t)/1000)*0+floor((7-t)/1000)*pi/20-floor((12-t)/1000)*pi/15+floor((42-t)/1000)*pi/14-floor((47-t)/1000)*0.1721],... 
    'nx',8,'nu',3 ...
);
% initial conditions
sys.initialCondition = {[0;20;40;0;0;1;50;0]};
...
va = VirtualArena(dtRealSystem,...
    'StoppingCriteria'  , @(t,sysList)t>45/dt,...
    'PlottingStep'      , 1/dt, ...
