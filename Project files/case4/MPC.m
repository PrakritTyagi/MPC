...
a0 = 250; % abscissa of Obstacle0
b0 = 100;  % ordinate of Obstacle0
h0 = 47;  % height of Obstacle0
a1 = 250; % abscissa of Obstacle1
b1 = -50; % ordinate of Obstacle2 
h1 = 47;  % height of obstacle1
a2 = 400; % abscissa of Obstacle2
...
sys = ICtSystem(...
    ...
    0-floor((25-t)/1000)+floor((26.65-t)/1000)],... 
    'nx',8,'nu',3 ...
);
% initial conditions
...
va = VirtualArena(dtRealSystem,...
    'StoppingCriteria'  , @(t,sysList)t>65/dt,...
    'PlottingStep'      , 1/dt, ...
