...
a0 = 180; % abscissa of Obstacle0
b0 = 25;  % ordinate of Obstacle0
h0 = 47;  % height of Obstacle0
a1 = 400; % abscissa of Obstacle1
b1 = 110; % ordinate of Obstacle2 
h1 = 47;  % height of obstacle1
a2 = 495; % abscissa of Obstacle2
b2 = 50;  % ordinate of Obstacle2
...
va = VirtualArena(dtRealSystem,...
    'StoppingCriteria'  , @(t,sysList)t>80/dt,...
    'PlottingStep'      , 1/dt, ...
